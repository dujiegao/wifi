...
#define MQTT_CLIENT_ID        "mybroker"    // the ID of yourself, any string is OK,client would use this ID register itself to MQTT server
...
#define MQTT_PASS            "123456" // you MQTT login password, same as above
#define STA_SSID "JYD_2.4G"    // your AP/router SSID to config your device networking
#define STA_PASS "guobingg810920" // your AP/router password
